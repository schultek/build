...
import 'package:jaspr_web_compilers/src/web_entrypoint_builder.dart';
  ...
  test('parses old dart2js options', () {
    ...
    expect(options.compilers, [
      isA<EnabledEntrypointCompiler>()
          ...
          .having((e) => e.compilerArguments, 'compilerArguments',
              ['-O4']).having((e) => e.extension, 'extension', '.dart.js')
    ]);
  });
  ...
  test('parses old dart2wasm options', () {
    ...
    expect(options.compilers, [
      isA<EnabledEntrypointCompiler>()
          ...
          .having((e) => e.compilerArguments, 'compilerArguments',
              ['-O4']).having((e) => e.extension, 'extension', '.mjs')
    ]);
  });
...
''') as Map;
    ...
    expect(options.compilers, [
      isA<EnabledEntrypointCompiler>()
          .having((e) => e.compiler, 'compiler', WebCompiler.Dart2Js)
          .having((e) => e.compilerArguments, 'compilerArguments',
              ['-O4']).having((e) => e.extension, 'extension', '.dart2js.js'),
      isA<EnabledEntrypointCompiler>()
          .having((e) => e.compiler, 'compiler', WebCompiler.Dart2Wasm)
          .having((e) => e.compilerArguments, 'compilerArguments', [
        '-O3'
